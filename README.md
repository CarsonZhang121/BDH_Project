...
The data preprocessing was accomplished in scala. The codes could be found in the main file of code folder while the library dependency would be found in the build.sbt. The original data file DIAGNOSES_ICD and NOTEEVENTS were download from MIMICiIII database and located into the data folder underneath the data_preprocess/code folder.
